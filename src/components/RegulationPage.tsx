      ...
      >
        ...
        <div className="mb-20">
          ...
          <p className="font-dm text-[14px] text-[var(--text-secondary)] mt-6 max-w-4xl leading-relaxed">
            Видео показывает внутренние стандарты работы предприятия:
            постановка задач, контроль исполнения, сдача результата.
            Это основа, в которую ИИ встраивается на каждом этапе.
          </p>
        </div>
