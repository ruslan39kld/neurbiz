...
export default function Sidebar({ activeTab, setActiveTab, theme, toggleTheme, isOpen, setIsOpen }: SidebarProps) {
  ...
  const navItems = [
    { id: 'about', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>, label: 'О проекте' },
